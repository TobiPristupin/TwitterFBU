...
* [x] UI content automatically shifts up when typing in compose tweet
* [x] Floating Action Button with Twitter icons is used to compose a new tweet
...
Walkthrough of loading indicator:
...
Working around Twitter's rate limiting and fixing OAuth errors. 

Managing the Room database in conjunction with the API and keeping all data up to date.
