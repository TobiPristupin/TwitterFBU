...
//	public static final String REST_CALLBACK_URL_TEMPLATE = "intent://";
    ...
    public void getHomeTimeline(String minTweetId, JsonHttpResponseHandler handler) {
        String apiUrl = getApiUrl("statuses/home_timeline.json");
        RequestParams params = new RequestParams();
        if (minTweetId != null) {
            params.put("max_id", minTweetId);
        }
    ...
    public void unRetweetTweet(Tweet tweet, JsonHttpResponseHandler handler) {
